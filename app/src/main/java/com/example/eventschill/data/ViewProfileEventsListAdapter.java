...
public class ViewProfileEventsListAdapter extends RecyclerView.Adapter<ViewProfileEventsListAdapter.ViewHolder> {

    public ArrayList<Event> events;
    public FragmentManager fragmentManager;


    public ViewProfileEventsListAdapter(LoggedInUser.User user, FragmentManager fragmentManager){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View userView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_profile_event_list, parent, false);
